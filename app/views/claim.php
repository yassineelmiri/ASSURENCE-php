<?php
require(__DIR__ . "/../controllers/Claim.php");
        ...
        <div class="h-screen flex  bg-gray-200">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex-1 overflow-auto p-4">
                    <h1 class="text-3xl font-bold mb-8">Ajouter Reclamation</h1>
                            ...
                            <div class="grid grid-cols-1 gap-5">
                                <div>
                                    ...
                                    <label for="article_id"
                                        class="block text-sm font-medium text-gray-700">article_id</label>
                                    <input type="text" name="article_id" id="article_id" placeholder="Enter article_id"
                                        class="mt-1 p-2 border border-gray-300 rounded-md w-full">
                                </div>
                    ...
                    <form action="" method="post" class="flex items-center space-x-2 " id="editForm<?= $claim['id'] ?>"
                        style="display: none;">
